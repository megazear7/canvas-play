  ...
  update() {
    this.lines.forEach(line => {
      if (this.targetDirection === 'right') {
        var newPoint = this.hovering ? newPoint = CpgMenuIcon.movePoint(line.x2, line.y2, this.targetX, this.targetY, this.speed) : newPoint = CpgMenuIcon.movePoint(line.x2, line.y2, line.initial.x2, line.initial.y2, this.speed);
        line.x2 = newPoint.x;
        line.y2 = newPoint.y;
      } else {
        var newPoint = this.hovering ? CpgMenuIcon.movePoint(line.x1, line.y1, this.targetX, this.targetY, this.speed) : newPoint = CpgMenuIcon.movePoint(line.x1, line.y1, line.initial.x1, line.initial.y1, this.speed);
        line.x1 = newPoint.x;
        line.y1 = newPoint.y;
      }
    });
